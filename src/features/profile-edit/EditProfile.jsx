        ...
        <div className="edit-profile-container">
            ...
            <div className="ep-header-card">
                ...
                <div className="ep-details">
                    ...
                    <p style={{ color: '#94a3b8', marginBottom: '4px' }}>Comprador</p>
                    <p style={{ color: '#64748b', fontSize: '0.9rem' }}>Miembro desde Enero 2024</p>
                </div>
            </div>

            {/* Security Alert */}
            <div className="ep-security-alert">
                <div style={{ color: '#3b82f6', fontSize: '1.25rem' }}>ℹ</div>
                <div>
                    <h4 style={{ color: '#1e40af', marginBottom: '4px' }}>Información de Seguridad</h4>
            ...
            <section className="ep-section">
                ...
                <div className="ep-pref-card">
                    ...
                    <div>
                        <h4 style={{ fontSize: '1rem', marginBottom: '4px' }}>Notificaciones por Email</h4>
                ...
                <div className="ep-pref-card">
                    <div style={{ color: '#64748b' }}>📱</div>
                    <div>
                        <h4 style={{ fontSize: '1rem', marginBottom: '4px' }}>Notificaciones por SMS</h4>
            ...
            <div className="ep-actions">
                <button className="ep-btn-save">Guardar Cambios</button>
                <button className="ep-btn-cancel">Cancelar</button>
            </div>
        </div>
    );
};
